...
if __name__ == '__main__':
    ...
    args_parser.add_argument('--predicted_sql_json_path', type=str, default='xxx.json')
    args_parser.add_argument('--ground_truth_sql_path', type=str, default='./data/dev/dev.sql')
    args_parser.add_argument('--data_mode', type=str, default='dev', choices=['train', 'dev', 'test'])
    ...
    print("predicted_sql_json_path: ", args.predicted_sql_json_path)
