...
if __name__ == '__main__':
    ...
    args_parser.add_argument('--predicted_sql_json_path', type=str, default='xxxx.json')
    args_parser.add_argument('--ground_truth_sql_path', type=str, default='./data/dev/dev.sql')
    args_parser.add_argument('--data_mode', type=str, default='dev')
    args_parser.add_argument('--db_root_path', type=str, default='./data/dev/dev_databases/')
    args_parser.add_argument('--num_cpus', type=int, default=12)
    args_parser.add_argument('--meta_time_out', type=float, default=60.0)
    args_parser.add_argument('--mode_gt', type=str, default='gt')
    args_parser.add_argument('--mode_predict', type=str, default='gpt')
    args_parser.add_argument('--diff_json_path', type=str, default='./data/dev/dev_process.json')
    args = args_parser.parse_args()
    exec_result = []

    pred_queries, _ = package_sqls(args.predicted_sql_json_path, args.db_root_path, 
    ...
    run_sqls_parallel(query_pairs, iterate_num=100, db_places=db_paths_gt, num_cpus=args.num_cpus, meta_time_out=args.meta_time_out)
